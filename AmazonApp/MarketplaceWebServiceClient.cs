...
namespace AmazonApp
{
    public class ResponseHeaderMetadata2
    {
        private String requestId;
        private String responseContext;
        private String timestamp;

        public ResponseHeaderMetadata2()
        {
            requestId = responseContext = timestamp = null;
        }

        public ResponseHeaderMetadata2(String requestId, String responseContext, String timestamp)
        {
    ...
    public class MarketplaceWebServiceClient : MarketplaceWebService
    {
        ...
        private T Invoke<T, K>(IDictionary<String, String> parameters, K clazz)
        {
            ...
            ResponseHeaderMetadata2 rhm = null;
            ...
            do
            {
                ...
                try
                {
                    ...
                    switch (requestType)
                    {
                        case RequestType.STREAMING:
                        {
                            ...
                            else
                            {
                                ...
                                request = ConfigureWebRequest(queryString, new ContentType("application/octet-stream"));
                            }
                        }
                            break;
                        default:
                    ...
                    using (HttpWebResponse httpResponse = request.GetResponse() as HttpWebResponse)
                    {
                        ...
                        rhm = new ResponseHeaderMetadata2(
                        ...
                        PropertyInfo pi = typeof(T).GetProperty("ResponseHeaderMetadata2");
         ...
         */
        private MarketplaceWebServiceException ReportAnyErrors(String responseBody, HttpStatusCode status, Exception e, ResponseHeaderMetadata2 rhm)
        {
